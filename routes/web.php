...
Route::middleware(SessionAuthenticate::class)->group(callback: function () {
    // Routes accessible by all authenticated users (admin and regular users)
    Route::get('/admin/dashboard', [DashboardController::class, 'index'])->name('DashboardPage');
    
    // Recipe Routes (accessible by all authenticated users)
    ...
    // Blog Routes (accessible by all authenticated users)
